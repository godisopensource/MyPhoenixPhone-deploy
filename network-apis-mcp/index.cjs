...
const registerPrompts = /* @__PURE__ */ __name((mcpServer2) => {
  mcpServer2.registerPrompt(
    "echo",
    {
      ...
      argsSchema: { message: zod.z.string() }
    },
    ({ message }) => ({
      messages: [
        {
...
const registerResources$5 = /* @__PURE__ */ __name((mcpServer2) => {
  mcpServer2.registerResource(
    ...
    new mcp_js.ResourceTemplate("device-location-retrieval://{phoneNumber}", { list: void 0 }),
    {
  ...
  mcpServer2.registerResource(
    ...
    new mcp_js.ResourceTemplate("device-location-retrieval://{phoneNumber}/maxAge/{maxAge}", { list: void 0 }),
    {
...
const registerResources$3 = /* @__PURE__ */ __name((mcpServer2) => {
  mcpServer2.registerResource(
    ...
    new mcp_js.ResourceTemplate("device-reachability-status://{phoneNumber}", { list: void 0 }),
    {
...
const registerResources$2 = /* @__PURE__ */ __name((mcpServer2) => {
  mcpServer2.registerResource(
    ...
    new mcp_js.ResourceTemplate("device-roaming-status://{phoneNumber}", { list: void 0 }),
    {
...
const registerResources$1 = /* @__PURE__ */ __name((mcpServer2) => {
  mcpServer2.registerResource(
    "sim-swap-date",
    new mcp_js.ResourceTemplate("sim-swap-date://{phoneNumber}", { list: void 0 }),
    {
      title: "SIM Swap Date",
  ...
  mcpServer2.registerResource(
    "sim-swap-check",
    new mcp_js.ResourceTemplate("sim-swap-check://{phoneNumber}/{hours}", { list: void 0 }),
    {
  ...
  mcpServer2.registerResource(
    ...
    new mcp_js.ResourceTemplate("sim-swap-check-default://{phoneNumber}", { list: void 0 }),
    {
...
const registerTools$8 = /* @__PURE__ */ __name((mcpServer2) => {
  mcpServer2.registerTool(
    "get-device-location",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().describe("Phone number in E.164 format (e.g., +33699901032)"),
        maxAge: zod.z.number().optional().describe("Maximum age of location data in seconds (optional)")
      }
    },
...
const registerTools$7 = /* @__PURE__ */ __name((mcpServer2) => {
  mcpServer2.registerTool(
    "verify-device-location",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().describe("Phone number in E.164 format (e.g., +33699901032)"),
        latitude: zod.z.number().describe("Latitude of the center point (-90 to 90)"),
        longitude: zod.z.number().describe("Longitude of the center point (-180 to 180)"),
        radius: zod.z.number().describe("Radius in meters (2000 to 200000)"),
        maxAge: zod.z.number().optional().describe("Maximum age of location data in seconds (optional)")
      }
    },
...
const registerTools$4 = /* @__PURE__ */ __name((mcpServer2) => {
  mcpServer2.registerTool(
    "kyc-match",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().optional().describe("Phone number in E.164 format (e.g., +34699901040)"),
        idDocument: zod.z.string().optional().describe("ID number associated to the official identity document"),
        name: zod.z.string().optional().describe("Complete name of the customer"),
        givenName: zod.z.string().optional().describe("First/given name of the customer"),
        familyName: zod.z.string().optional().describe("Last name, family name, or surname of the customer"),
        middleNames: zod.z.string().optional().describe("Middle name/s of the customer"),
        familyNameAtBirth: zod.z.string().optional().describe("Last/family/surname at birth of the customer"),
        address: zod.z.string().optional().describe("Complete address of the customer"),
        streetName: zod.z.string().optional().describe("Name of the street of the customer's address"),
        streetNumber: zod.z.string().optional().describe("The street number of the customer's address"),
        postalCode: zod.z.string().optional().describe("Zip code or postal code"),
        region: zod.z.string().optional().describe("Region/prefecture of the customer's address"),
        locality: zod.z.string().optional().describe("Locality of the customer's address"),
        country: zod.z.string().optional().describe("Country of the customer's address (ISO 3166-1 alpha-2)"),
        houseNumberExtension: zod.z.string().optional().describe("Specific identifier of the house (e.g., apartment number)"),
        birthdate: zod.z.string().optional().describe("The birthdate of the customer (YYYY-MM-DD format)"),
        email: zod.z.string().optional().describe("Email address of the customer"),
        gender: zod.z.enum(["MALE", "FEMALE", "OTHER"]).optional().describe("Gender of the customer")
      }
    },
    async (params) => {
      try {
...
`;
  ...
  mcpServer2.registerTool(
    "create-playground-phone-number",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().describe("Phone number in E.164 format (e.g., +33612345678)")
      }
    },
    async ({ phoneNumber }) => {
      try {
...
`;
  ...
  mcpServer2.registerTool(
    "update-playground-phone-location",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().describe("Phone number in E.164 format (e.g., +33612345678)"),
        latitude: zod.z.number().min(-90).max(90).describe("Latitude (-90 to 90)"),
        longitude: zod.z.number().min(-180).max(180).describe("Longitude (-180 to 180)"),
        radius: zod.z.number().min(1).describe("Radius in meters"),
        available: zod.z.boolean().optional().describe("Location availability (default: true)"),
        lastLocationTime: zod.z.string().optional().describe("Last location time (ISO format, default: current time)")
      }
    },
...
`;
  ...
  mcpServer2.registerTool(
    "update-playground-phone-kyc",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().describe("Phone number in E.164 format (e.g., +33612345678)"),
        name: zod.z.string().optional().describe("Full name"),
        givenName: zod.z.string().optional().describe("Given/first name"),
        familyName: zod.z.string().optional().describe("Family/last name"),
        email: zod.z.string().email().optional().describe("Email address"),
        birthdate: zod.z.string().optional().describe("Birthdate (YYYY-MM-DD format)"),
        gender: zod.z.enum(["MALE", "FEMALE", "OTHER"]).optional().describe("Gender"),
        address: zod.z.string().optional().describe("Full address"),
        country: zod.z.string().optional().describe("Country")
      }
    },
...
`;
  ...
  mcpServer2.registerTool(
    "delete-playground-phone-number",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().describe("Phone number in E.164 format (e.g., +33612345678)"),
        confirm: zod.z.boolean().describe("Confirmation flag - must be true to proceed with deletion")
      }
    },
...
`;
  ...
  mcpServer2.registerTool(
    "update-playground-phone-reachability",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().describe("Phone number in E.164 format (e.g., +33612345678)"),
        reachabilityStatus: zod.z.enum(["CONNECTED_DATA", "CONNECTED_SMS", "NOT_CONNECTED"]).describe("Reachability status"),
        lastStatusTime: zod.z.string().optional().describe("Last status time (ISO format, default: current time)")
      }
    },
...
`;
  ...
  mcpServer2.registerTool(
    "update-playground-phone-roaming",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().describe("Phone number in E.164 format (e.g., +33612345678)"),
        roaming: zod.z.boolean().describe("Roaming status (true if roaming, false if home network)"),
        countryCode: zod.z.number().optional().describe("Country code (required if roaming is true)"),
        countryName: zod.z.array(zod.z.string()).optional().describe("Country name(s) (optional)"),
        lastStatusTime: zod.z.string().optional().describe("Last status time (ISO format, default: current time)")
      }
    },
...
`;
  ...
  mcpServer2.registerTool(
    "update-playground-phone-sim-swap",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().describe("Phone number in E.164 format (e.g., +33612345678)"),
        latestSimChange: zod.z.string().describe("Latest SIM change timestamp (ISO format, e.g., 2024-01-01T12:00:00.000Z)")
      }
    },
  ...
  mcpServer2.registerTool(
    "get-population-density-data",
    {
      ...
      inputSchema: {
        ...
        startTime: zod.z.string().describe("Start date time in RFC 3339 format (e.g., 2024-04-23T14:44:18.165Z)"),
        endTime: zod.z.string().describe("End date time in RFC 3339 format (e.g., 2024-04-23T14:44:18.165Z)"),
        precision: zod.z.number().min(1).max(12).optional().describe("Precision level (geohash length) between 1-12, default is 7")
      }
    },
...
`;
  ...
  mcpServer2.registerTool(
    "check-sim-swap",
    {
      ...
      inputSchema: {
        phoneNumber: zod.z.string().describe("Phone number in E.164 format (e.g., +33699901032)"),
        hours: zod.z.number().describe("Number of hours to check back (e.g., 24 for last 24 hours)")
      }
    },
