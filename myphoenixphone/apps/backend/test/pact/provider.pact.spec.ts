    ...
    const opts = {
      ...
      stateHandlers: {
        ...
        'user has valid consent and eligible device': async () => {
          ...
          console.log('Setting up: user with valid consent and eligible device');
          return Promise.resolve({
            description: 'User has valid consent, SIM swap detected within 30 days',
          });
        },

        'user has valid consent and ineligible device': async () => {
          console.log('Setting up: user with valid consent and ineligible device');
          return Promise.resolve({
