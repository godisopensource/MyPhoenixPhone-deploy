...
export const validDormantEvents = [
  ...
  },
  {
    ...
    event: {
      msisdn_hash: '6f995909eb39158262e1f67a9ed7382884714e1e7dbccd73c22fg832e2653e9',
      sim_swap: {
        occurred: true,
  ...
  },
  {
    ...
    event: {
      msisdn_hash: 'a1b2c3d4e5f6789012345678901234567890123456789012345678901234abcd',
      sim_swap: {
        occurred: true,
  ...
  },
  {
    ...
    event: {
      msisdn_hash: 'b2c3d4e5f67890123456789012345678901234567890123456789012345bcde',
      sim_swap: {
        occurred: true,
  ...
  },
  {
    ...
    event: {
      msisdn_hash: 'c3d4e5f678901234567890123456789012345678901234567890123456cdef',
      sim_swap: {
        occurred: true,
        ts: '2025-10-19T10:00:00Z',
      },
  ...
  },
  {
    ...
    event: {
      msisdn_hash: 'd4e5f6789012345678901234567890123456789012345678901234567def0',
      sim_swap: {
        occurred: true,
  ...
  },
  {
    ...
    event: {
      msisdn_hash: 'e5f67890123456789012345678901234567890123456789012345678ef01',
      sim_swap: {
        occurred: true,
        ts: '2025-10-18T10:00:00Z',
      },
  ...
  },
  {
    ...
    event: {
      msisdn_hash: 'f6789012345678901234567890123456789012345678901234567890f012',
      sim_swap: {
        occurred: true,
        ts: '2025-10-18T10:00:00Z',
      },
  ...
  },
  {
    ...
    event: {
      msisdn_hash: '789012345678901234567890123456789012345678901234567890120123',
      sim_swap: {
        occurred: true,
  ...
  },
  {
    ...
    event: {
      msisdn_hash: '890123456789012345678901234567890123456789012345678901201234',
      sim_swap: {
        occurred: true,
...
export const invalidLeadOutputs = [
  ...
  },
  {
    ...
    expectedError: 'next_action must be one of [send_nudge, hold, exclude, expired]',
  },
];
...
export function calculateMockEstimate(
  ...
  let basePrice = (tier.min + tier.max) / 2;
